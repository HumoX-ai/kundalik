...
function createData(reason, grade, comment) {
  return { reason, grade, comment };
}
...
const rows = [
  createData('Homework', 59, "juda yaxshi"),
  createData('Lesson', 48, "zo'r qatnashdi"),
  createData('Extra', 57, "yaxshi"),
];
